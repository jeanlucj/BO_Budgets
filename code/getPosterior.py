...
ro.globalenv['bestBudget'] = x_opt
ro.globalenv['expectedGain'] = expected_gain
ro.globalenv['postVarGain'] = post_var_gain
...
if pred_points:
    ...
    ro.globalenv['predGains'] = pred_gains
    ro.globalenv['predVars'] = pred_vars
